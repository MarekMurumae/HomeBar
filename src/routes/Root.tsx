        ...
        <div className="z-index: 1 bg-gray-800 flex flex-col ">
               <ul className="list-reset flex flex-row md:flex-row text-center">
                  <li className="mr-3 flex-1">
                     <Link to="/" className="block py-1 md:py-3 pl-1 align-middle no-underline hover:text-pink-500 border-b-2 border-gray-800 md:border-gray-900 hover:border-pink-300 focus:border-pink-500">
                  ...
                  <li className="mr-3 flex-1">
                     <Link to="/recipes" className="block py-1 md:py-3 pl-1 align-middle no-underline hover:text-pink-500 border-b-2 border-gray-800 md:border-gray-900 hover:border-pink-300 focus:border-pink-500">
